...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="dlvyCompNo" class="ct_input_bg" style="width:150px; height:19px" value="${deliveryCompanyVO.dlvyCompNo }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="dlvyCompName" style="width:150px; height:19px" value="${deliveryCompanyVO.dlvyCompName }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="businessNo" style="width:150px; height:19px" value="${deliveryCompanyVO.businessNo }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			<select name="useYn" style="width:80px">
				<option value="Y" <c:if test="${deliveryCompanyVO.useYn == 'Y' }">selected</c:if>>사용</option>
				<option value="N" <c:if test="${deliveryCompanyVO.useYn == 'N' }">selected</c:if>>중지</option>				
			</select>			
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<textarea name="dlvyCompDesc" cols="50" rows="5">${deliveryCompanyVO.dlvyCompDesc }</textarea>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
