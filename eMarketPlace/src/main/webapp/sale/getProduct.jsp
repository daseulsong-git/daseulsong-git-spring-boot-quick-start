...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="prodNo" class="ct_input_bg" style="width:100px; height:19px" value="${productVO.prodNo }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="prodName"  style="width:100px; height:19px" value="${productVO.prodName }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<c:forEach var="categoryVO" items="${categoryList }">
				<option value="${productVO.categoryNo }" <c:if test="${productVO.categoryNo == categoryVO.categoryNo }">selected</c:if>>${categoryVO.categoryName }</option>
			</c:forEach>
			</select>
		</td>
	</tr>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<textarea name="prodDetail"  cols="50" rows="5">${productVO.prodDetail }</textarea>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name=manufactureDay  style="width:100px; height:19px" value="${productVO.manufactureDay }">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="sellQuantity"  style="width:100px; height:19px;text-align:right" value="${productVO.sellQuantity }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="sellAmount"  style="width:100px; height:19px;text-align:right" value="${productVO.sellAmount }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<img src="images/upload_files/productImage/${productVO.imageFile }" width="300" height="200" alt="상품 이미지" border="0">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="checkbox" name="checkAsYn" <c:if test="${productVO.asYn == 'Y' }">selected</c:if> onChange="check_asYn(this)"> A/S 가능합니다.
			<input type="hidden" name="asYn" value="${productVO.asYn }">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
