...
function resetData() {
    document.detailForm.action='/getCategoryList.do';
    document.detailForm.submit();
}
-->
</script>
...
<input type="hidden" name="modifyId" value="${userId }"/>
<!--************************** 컨텐츠 S *****************************-->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:13px;">
	...
	<tr>
		...
		<td class="ct_write01">
			<input type="text" name="categoryNo" class="ct_input_bg" style="width:150px; height:19px" value="${categoryVO.categoryNo }" readonly maxLength="20" char="s">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<input type="text" name="categoryName"  style="width:150px; height:19px" value="${categoryVO.categoryName }" required fieldTitle="카테고리명" maxLength="50" minLength="2" char="sn">
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">
			<textarea name="categoryDesc" cols="50" rows="5">${categoryVO.categoryDesc }</textarea>
		</td>
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
