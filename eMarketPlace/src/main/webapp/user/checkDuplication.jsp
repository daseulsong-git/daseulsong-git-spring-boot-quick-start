...
function fncUseId() {
	if(opener) {
		opener.document.detailForm.userId.value = "${userVO.userId }";
	}
	...
	<tr>
		...
		<td class="ct_write01">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<td width="105">
						<input type="text" name="userId" id="userId" style="width:100px; height:19px" value="${userVO.userId }">
					</td>
					<td>
